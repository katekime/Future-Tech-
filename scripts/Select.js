...
class Select extends BaseComponent{
    ...
    stateClasses = {
        ...
        isLeftSide: 'is-on-the-left-side',
        isRightSide: 'is-on-the-right-side',
    }
    stateAttributes = {
    ...
    constructor(rootElement) {
        ...
        this.state = this.getProxyState({
            ...this.initialState,
            currentOptionIndex: this.originalControlElement.selectedIndex, // Это свойство дом элемента select. Текущий индекс выбранной опции.
            selectedOptionElement: this.optionElements[this.originalControlElement.selectedIndex],
        })
        this.fixDropdownPosition()
        this.updateTabIndexes()
        this.bindEvents()
        document.addEventListener('keydown', this.comboBox)
    }
    comboBox(event) {
    ...
    fixDropdownPosition() {
        ...
        this.dropdownElement.classList.toggle(this.stateClasses.isLeftSide, isButtonOnTheLeftViewportSide)
        this.dropdownElement.classList.toggle(this.stateClasses.isRightSide, !isButtonOnTheLeftViewportSide)
    }
